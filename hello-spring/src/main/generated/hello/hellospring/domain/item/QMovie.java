...
public class QMovie extends EntityPathBase<Movie> {
    ...
    private static final long serialVersionUID = 1238553844L;
    ...
    //inherited
    public final ListPath<hello.hellospring.domain.Category, hello.hellospring.domain.QCategory> categories = _super.categories;

    public final StringPath dircetor = createString("dircetor");
