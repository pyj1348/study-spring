...
### 1. Spring Framework
    ...
    애플리케이션을 개발할 때 필요한 수많은 강력하고 편리한 기능을 제공하는 프레임워크
    객체의 "생명주기"를 알아서 관리
...
### 2. Spring-boot
    ...
    Spring이 제공하는 기능들을 사용하기 위해서는 프로젝트를 세팅하는 수많은 복잡한 설정값을 관리하는 데
    많은 어려움이 있었는데 스프링부트는 dependencies 등등을 자동으로 설정해준다
